 ...
 */
 ...
 public class TestingLista {
     ...
     public static void testLista() {
         ...
         System.out.print("Inserta 5 pos 5 espera FALSE y lista vacia: \t" + ((l1.insertar(5, 5) == false) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Inserta 2 pos 1 espera TRUE y [2]: \t\t" + ((l1.insertar(2, 1) == true) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Inserta 1 pos 1 espera TRUE y [1,2]: \t\t" + ((l1.insertar(1, 1) == true) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Inserta 3 pos long+1 espera TRUE y [1,2,3]: \t" + ((l1.insertar(3, l1.longitud() + 1) == true) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Inserta 5 pos 4 espera TRUE y [1,2,3,5]: \t" + ((l1.insertar(5, 4) == true) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Inserta 4 pos 4 espera TRUE y [1,2,3,4,5]: \t" + ((l1.insertar(4, 4) == true) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         ...
         System.out.print("Inserta 10 pos long+2 espera FALSE y [1,2,3,4,5]: " + ((l1.insertar(10, l1.longitud() + 2) == false) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         ...
         System.out.print("Elimina pos -1 espera FALSE y [1,2,3,4,5]: \t" + ((l1.eliminar(-1) == false) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Elimina pos 0 espera FALSE y [1,2,3,4,5]: \t" + ((l1.eliminar(0) == false) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
         System.out.print("Elimina pos 10 espera FALSE y [1,2,3,4,5]: \t" + ((l1.eliminar(10) == false) ? sOk : sErr));
         System.out.println("\t--> " + l1.toString());
