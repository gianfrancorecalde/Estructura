package Estructura.Lineales.Dinamicas;
...
public class Cola {
    ...
    public Cola generarOtraCola(){
        ...
        while(recorrerCola != null){
            ...
            if(recorrerCola.getElemento() != "$" || recorrerCola.getEnlace()== null ){

                pilaAuxiliar.apilar(recorrerCola.getElemento());
                newCola.poner(recorrerCola.getElemento());
            }else{

                while(pilaAuxiliar.obtenerTope() != null){

                    newCola.poner(pilaAuxiliar.obtenerTope());
